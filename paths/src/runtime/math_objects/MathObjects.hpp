...
enum class MathObjectKind : std::uint8_t { Algebra, Trig, Calculus, Linear, Discrete, Function, Surface, Symmetry, Harmonics, Oscillator, Modular, Gaussian, VectorField, Flux, Tensor, Probability, Binomial, Bayes, Covariance, Spherical, Quadratic, Roots, Psd, Norm, Curve, Lathe, Boolean, Patch, Membrane, Rigid, Truss, Count };
enum class MathParameter : std::uint16_t {
  ...
  TrussShape, TrussSpan, TrussHeight, TrussLean, TrussJoint, TrussP0X, TrussP0Y, TrussP1X, TrussP1Y, TrussP2X, TrussP2Y, TrussP3X, TrussP3Y, TrussP4X, TrussP4Y, TrussP5X, TrussP5Y, TrussPosition, TrussLoadX, TrussLoadY, TrussMember, TrussBrace, TrussSupports, TrussTensionLimit, TrussCompressionLimit, TrussGuides, Count
};
