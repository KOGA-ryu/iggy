...
@lesson linear_worked_v1_zero_solution_reading | Zero as the solution
@template lesson.v2
@block introduction | zero_solution_start | 1 | One unknown, balanced operations
...
@endblock
@block definition | zero_solution_terms | 1.1 | Coefficient and constant
...
ax+b=c,\qquad a\ne0
@endblock
@block introduction | zero_solution_controls | 1.2 | Choose your support
...
@endblock
@practice linear_worked_v1_6b6dcaeb7a6138b4c65518ce961ce46c
@practice linear_worked_v1_9d020c881bf273bbb442a0df24abb39b
@end

@question linear_worked_v1_6b6dcaeb7a6138b4c65518ce961ce46c | Zero as the solution · Exercise 1
@template linear.v1
@version 1
...
@step 10 | Subtract (4) on both sides. Complete 2x = ?
@choice 11 | 4
@choice 12 | 0
@choice 13 | 8
@answer 12
...
Here the coefficient is $2$, the added constant is $4$, and the right-hand side is $4$. Subtract the added constant from both complete sides:

$$2x+4 -\left(4\right)=4 -\left(4\right).$$
...
@step 20 | Divide both sides by (2). Complete x = ?
@choice 21 | 0
@choice 22 | 2
@choice 23 | -2
@answer 21
...
@teaching
The coefficient is $2$, which is nonzero. Divide both sides of the reached equation by it:
...
@question linear_worked_v1_9d020c881bf273bbb442a0df24abb39b | Zero as the solution · Exercise 2
@template linear.v1
@version 1
@goal Solve for x and check the result in the original equation.
@given 2x+7=7
...
@step 10 | Subtract (7) on both sides. Complete 2x = ?
@choice 11 | 7
@choice 12 | 0
@choice 13 | 14
@answer 12
...
Here the coefficient is $2$, the added constant is $7$, and the right-hand side is $7$. Subtract the added constant from both complete sides:

$$2x+7 -\left(7\right)=7 -\left(7\right).$$
