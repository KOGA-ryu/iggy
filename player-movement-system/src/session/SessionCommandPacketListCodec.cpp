#include "SessionCommandPacketListCodec.hpp"
...
SessionCommandLogBytes SessionCommandPacketListCodec::encode(const std::vector<SessionCommandBytes> &packets) const
{
...
std::optional<std::vector<SessionCommandBytes>> SessionCommandPacketListCodec::decode(const SessionCommandLogBytes &bytes) const
{
