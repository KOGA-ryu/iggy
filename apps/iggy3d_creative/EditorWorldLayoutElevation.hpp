...
using CreativeEditorWorldLayoutLevelEditScope =
    cr::CreativeWorldLayoutLevelDatumEditScope;

enum class CreativeEditorWorldLayoutSectionPartitionExtent : std::uint8_t {
  None,
  AuthoredHeight,
  ClippedByUpperFloor,
  Count,
...
struct CreativeEditorWorldLayoutSectionLevel {
  ...
  CreativeEditorWorldLayoutSectionPartitionExtent partitionExtent =
...
using CreativeEditorWorldLayoutLevelDatumEditRequest =
    cr::CreativeWorldLayoutLevelDatumEditRequest;
using CreativeEditorWorldLayoutLevelDatumEditPlan =
    cr::CreativeWorldLayoutLevelDatumEditPlan;
