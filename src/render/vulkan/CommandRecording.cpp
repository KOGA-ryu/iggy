...
using command_recording_internal::ResolvedSceneRect;
...
using command_recording_internal::resolveSceneRect;
using command_recording_internal::setViewportAndScissor;
