...
constexpr auto kDescriptors = std::to_array<CreativeObjectDescriptor>({
    ...
    descriptor(CreativeObjectKind::PatrolRoute, CreativeObjectCategory::Gameplay, CreativeObjectProfile::LinkOrRoute, CreativeObjectShapeKind::Path, CreativeSpatialProjectionProfile::PathProjection, CreativeSpatialOccupancyKind::Gameplay, "PatrolRoute", "Patrol Route", "AI patrol route", navigationCreationDirtyFlags() | flagValue(CreativeObjectDirtyFlag::Gameplay), markerDefaults(), false, false, false, true, true, false),
