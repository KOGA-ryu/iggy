...
using InteractionMode = CreativeHeldItemInteractionMode;
...
[[nodiscard]] consteval auto makeHeldItemDefinitions() {
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::ObjectMove;
    row.hierarchySelectionTool = true;
  }
  {
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainControl;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainPaint;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainGrade;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainSculpt;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainProfile;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainPath;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
  ...
  }
  {
    ...
    row.interactionMode = InteractionMode::TerrainRegion;
    row.targetCellPolicy = TargetPolicy::DocumentGrid;
