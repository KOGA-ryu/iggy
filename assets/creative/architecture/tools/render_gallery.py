...
ASSETS = [
    ...
    "openings/door_frame_double",
    "openings/door_leaf_double_left_closed",
    "openings/door_leaf_double_left_open",
    "openings/door_leaf_double_right_closed",
    "openings/door_leaf_double_right_open",
    "openings/window_frame_standard",
    "openings/window_frame_small",
    "openings/window_frame_wide",
    "openings/window_frame_tall",
    "openings/window_bars_standard",
    ...
    "traversal/stair_quarter_turn_3m",
    "traversal/stair_landing_2x2m",
    "traversal/stair_landing_2x4m",
    "traversal/ramp_2x3x1p5m",
    "traversal/ramp_2x6x3m",
    "traversal/ramp_landing_2x2m",
    ...
    "structural/foundation_plinth_straight_2m",
    "structural/foundation_plinth_straight_4m",
    "structural/foundation_plinth_inner_corner",
    "structural/foundation_plinth_outer_corner",
    "structural/foundation_plinth_end",
    "structural/post_square_0p3x3m",
    "structural/post_square_0p5x3m",
    "structural/column_round_0p5x3m",
    "structural/column_round_base",
    "structural/column_round_cap",
    "structural/beam_2m",
    "structural/beam_4m",
    "structural/beam_6m",
    "structural/beam_end_cap",
    "structural/brace_left",
    "structural/brace_right",
    "structural/arch_1p2m",
    "structural/arch_2m",
    "structural/arch_4m",
    "structural/buttress_low",
    "structural/buttress_tall",
    "structural/wall_pier_0p5x3m",
    "structural/wall_pier_1x3m",
    "structural/parapet_straight_2m",
    "structural/parapet_straight_4m",
    "structural/parapet_inner_corner",
    "structural/parapet_outer_corner",
    "structural/parapet_end",
    "structural/balcony_deck_2x1p5m",
    "structural/balcony_deck_4x1p5m",
    "structural/balcony_bracket",
    "structural/railing_straight_1m",
    "structural/railing_corner",
    "structural/railing_end_post",
