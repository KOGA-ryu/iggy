"""ASSET-BLD-1 two_storey_estate assembly proof: renders the ENGINE FIXTURE.

Parses fixtures/worlds/two_storey_estate.iggy3d.save and imports every Prop's GLB
...
Writes /tmp/bld3_estate/estate_front.png, estate_three_quarter.png,
estate_porch_detail.png.
"""
import math
import os
import re
...
SAVE = os.path.join(ROOT, "fixtures", "worlds", "two_storey_estate.iggy3d.save")
...
SHOTS = [
    ("estate_front.png", (0.0, -19.5, 4.2), (0.0, 0.0, 3.4)),
    ("estate_three_quarter.png", (13.5, -13.0, 6.5), (0.0, 0.5, 3.2)),
    ("estate_porch_detail.png", (3.4, -6.8, 2.2), (-0.3, -0.6, 1.6)),
]
