"""ASSET-BLD-1 framing_bay assembly proof: renders the ENGINE FIXTURE.

Parses fixtures/worlds/framing_bay.iggy3d.save and imports every Prop's GLB
...
Writes /tmp/bld2_framing/framing_front.png, framing_three_quarter.png,
framing_door_detail.png.
"""
import math
import os
import re
...
SAVE = os.path.join(ROOT, "fixtures", "worlds", "framing_bay.iggy3d.save")
CREATIVE = os.path.join(ROOT, "assets", "creative")
OUT = "/tmp/bld2_framing"
...
SHOTS = [
    ("framing_front.png", (0.0, -14.5, 2.4), (0.0, 0.0, 1.6)),
    ("framing_three_quarter.png", (10.5, -10.5, 4.2), (0.5, 0.0, 1.6)),
    ("framing_door_detail.png", (2.8, -4.6, 1.8), (0.0, 0.0, 1.4)),
]
