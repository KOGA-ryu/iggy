...
- NPC AI tactical maps, behavior pools, trait sets, trait pools/draws, hand/read/play/tell/fold reports, Play-control proposal/apply/report boundaries, actor registries, control registries, decision reports, route/path reports, movement proposals, and command-frame mappers validate inputs, preserve order, and avoid mutation
...
- duplicating scene/ai trait draw, hand/read/play/tell/fold, Play-control proposal/apply/report, scoring, routing, path-report, or movement-proposal rules
