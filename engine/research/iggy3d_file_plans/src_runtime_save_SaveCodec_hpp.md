...
- first build should use a first-party deterministic tagged text format unless a dependency is explicitly adopted in CMake
...
- unknown future fields are handled by compatibility rules
