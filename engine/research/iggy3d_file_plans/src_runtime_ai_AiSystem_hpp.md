...
- returns command proposals for later admission
- uses stable actor/entity ordering

## Semantics

- no unseeded randomness
- no direct mutation except AI state bookkeeping through owning API
- proposals may be rejected by normal command admission
