...
Exact purpose: declare deterministic clock decisions from clock state and session control commands.
...
- `src/runtime/clock/Clock.hpp` exists in `/Users/kogaryu/iggy3d`;
