...
Exact purpose: declare movement request/result values used by command execution and tactical movement tests.
...
- walk/reposition/tactical move modes
- actor id
- target point
- max distance override if provided by config

## Semantics

- value type only
- does not mutate world
- movement system validates distance and applies transform updates
