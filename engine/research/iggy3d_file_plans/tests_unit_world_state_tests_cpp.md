...
Exact purpose: prove entity allocation and world mutation behavior for the complete `iggy3d` runtime.
...
- lookup invalid id fails
- transform update works
- reset baseline restores fixture state
...
- `tests/unit/world_state_tests.cpp` exists in `/Users/kogaryu/iggy3d`;
