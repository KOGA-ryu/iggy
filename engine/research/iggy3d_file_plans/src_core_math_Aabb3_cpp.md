...
Exact purpose: implement axis-aligned bounds for reach checks, target discovery, broadphase-friendly collision, and scene projection.
...
- reach uses closest point on target bounds
