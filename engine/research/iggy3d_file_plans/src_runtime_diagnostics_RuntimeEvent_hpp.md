...
- command accepted/rejected, moved, interacted, item acquired, objective completed, clock changed, camera changed, save loaded, reset

## Semantics

- events are derived/transient unless promoted into save debug section
