...
Exact purpose: prove session lifecycle and facade behavior behavior for the complete `iggy3d` runtime.
...
- create from fixture seed
- submit accepted/rejected command logs
- reset restores baseline
- derived diagnostics remain outside save truth
