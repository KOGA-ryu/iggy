...
Exact purpose: implement legal camera transitions between realtime and tactical modes.
...
- `src/runtime/camera/CameraModePolicy.cpp` exists in `/Users/kogaryu/iggy3d`;
