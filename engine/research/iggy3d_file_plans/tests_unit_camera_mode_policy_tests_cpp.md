...
Exact purpose: prove realtime and tactical camera transitions behavior for the complete `iggy3d` runtime.
...
- first-person realtime option
- slow time switches tactical
- normal restores prior realtime
- input clear flag set on major transition
...
- `tests/unit/camera_mode_policy_tests.cpp` exists in `/Users/kogaryu/iggy3d`;
