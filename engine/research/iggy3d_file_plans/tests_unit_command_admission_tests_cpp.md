...
Exact purpose: prove authority and command legality behavior for the complete `iggy3d` runtime.
...
- slot/actor mismatch rejects
- out-of-range interact rejects OutOfRange
- paused movement rejects unless step/control command
- retry resolves previous rejected command after state changes
