...
Exact purpose: prove content package loading and validation behavior for the complete `iggy3d` runtime.
...
- valid first-room package loads
- missing required field fails
- bad scenario path reports diagnostic
- duplicate names/ids fail validation
...
- `tests/unit/package_loader_tests.cpp` exists in `/Users/kogaryu/iggy3d`;
