...
Exact purpose: declare the authoritative entity collection and deterministic world mutation API.
...
- `src/runtime/world/WorldState.hpp` exists in `/Users/kogaryu/iggy3d`;
