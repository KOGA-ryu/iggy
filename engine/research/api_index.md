...
- `RuntimeGameplayAsciiSourcePlanTomlReader`: narrow dependency-free reader for the supported in-memory TOML subset into `RuntimeGameplayAsciiSourcePlan`, preserving nested source-plan validation diagnostics; not full TOML compliance, no file IO, and no scenario conversion or runtime execution.
