...
- `RuntimeGameplaySaveSlotStore`: gameplay-specific named slot API over `RuntimeGameplaySnapshotSaveLoad`, separate from the existing session `RuntimeSaveSlotStore` and without UI/runtime autosave integration.
