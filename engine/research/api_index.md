...
- `RuntimeGameplayAsciiScenarioPacket`: typed in-memory ASCII scenario packet for future external adapters; preserves rows, marker declarations, and frame declarations without parsing files or converting to gameplay scenarios.
