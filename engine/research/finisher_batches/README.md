...
2. `02_roadmap_status_sync` - pending. Keep roadmap accurate after Batch 09/10 and facade pull-forward.
3. `03_authoring_bucket_status_sync` - pending. Reduce bucket workflow drift without renumbering packets.
