...
iggy::npc_ai::NpcAgentRenderCommandConfig Config(int layer = 9)
{
...
{
	const iggy::render::RenderCommandList2D commands = iggy::npc_ai::NpcAgentRenderCommands {}.build({}, Config());
...
void TestOneAgentEmitsDefaultCenteredQuad()
{
	...
	const iggy::render::RenderCommandList2D commands = iggy::npc_ai::NpcAgentRenderCommands {}.build(agents, Config(4));
...
void TestCustomSizeAndAnchorProduceExpectedBounds()
{
	...
	const iggy::npc_ai::NpcAgentRenderCommandConfig config { NpcMaterial, { 2.0F, 4.0F }, { 0.0F, 1.0F }, 6 };

	const iggy::render::RenderCommandList2D commands = iggy::npc_ai::NpcAgentRenderCommands {}.build(agents, config);
...
void TestMultipleAgentsPreserveOrderAndCommandOrder()
{
	...
	const iggy::render::RenderCommandList2D commands = iggy::npc_ai::NpcAgentRenderCommands {}.build(agents, Config(5));
...
void TestNegativeSizeIsNormalized()
{
	...
	const iggy::npc_ai::NpcAgentRenderCommandConfig config { NpcMaterial, { -2.0F, -4.0F }, { 0.5F, 0.5F }, 2 };
...
void TestZeroSizeProducesDegenerateBounds()
{
	...
	const iggy::npc_ai::NpcAgentRenderCommandConfig config { NpcMaterial, { 0.0F, 0.0F }, { 0.5F, 0.5F }, 2 };
...
void TestEmptyMaterialIdIsPreserved()
{
	...
	const iggy::npc_ai::NpcAgentRenderCommandConfig config { {}, { 1.0F, 1.0F }, { 0.5F, 0.5F }, 2 };
...
void TestTileAndNpcCommandsShareRenderCommandContract()
{
	...
	const iggy::render::RenderCommandList2D npcCommands = iggy::npc_ai::NpcAgentRenderCommands {}.build(agents, Config(7));
