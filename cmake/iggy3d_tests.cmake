...
iggy3d_add_unit_test(traversal_tag_catalog_tests
  tests/unit/traversal_tag_catalog_tests.cpp)
set_tests_properties(traversal_tag_catalog_tests PROPERTIES
  LABELS "unit;content;room_asset;traversal;iggy3d")
...
iggy3d_add_unit_test(product_creative_ui_projection_receipt_tests
...
iggy3d_add_unit_test(product_creative_ui_window_frame_tests
  tests/unit/product_creative_ui_window_frame_tests.cpp)
set_tests_properties(product_creative_ui_window_frame_tests PROPERTIES
  LABELS "unit;app;product;creative;ui;window;frame;iggy3d")

iggy3d_add_unit_test(product_creative_window_coordinate_space_tests
  tests/unit/product_creative_window_coordinate_space_tests.cpp)
set_tests_properties(product_creative_window_coordinate_space_tests PROPERTIES
  LABELS "unit;app;product;creative;window;coordinate_space;iggy3d")

iggy3d_add_unit_test(product_creative_ui_input_frame_tests
...
iggy3d_add_unit_test(product_creative_ui_command_frame_tests
  tests/unit/product_creative_ui_command_frame_tests.cpp)
set_tests_properties(product_creative_ui_command_frame_tests PROPERTIES
  LABELS "unit;app;product;creative;ui;command;window;frame;iggy3d")

iggy3d_add_unit_test(product_creative_ui_command_receipt_tests
  tests/unit/product_creative_ui_command_receipt_tests.cpp)
set_tests_properties(product_creative_ui_command_receipt_tests PROPERTIES
  LABELS "unit;app;product;creative;ui;command;receipt;iggy3d")
...
iggy3d_add_unit_test(product_creative_wireframe_frame_tests
  tests/unit/product_creative_wireframe_frame_tests.cpp)
set_tests_properties(product_creative_wireframe_frame_tests PROPERTIES
  LABELS "unit;app;product;creative;wireframe;frame;iggy3d")
...
iggy3d_add_unit_test(product_creative_pick_flow_tests
  tests/unit/product_creative_pick_flow_tests.cpp)
set_tests_properties(product_creative_pick_flow_tests PROPERTIES
  LABELS "unit;app;product;creative;pick;flow;iggy3d")
...
set_tests_properties(product_creative_input_frame_tests PROPERTIES
  LABELS "unit;app;product;creative;input;window;frame;iggy3d")

iggy3d_add_unit_test(product_creative_move_drag_frame_tests
  tests/unit/product_creative_move_drag_frame_tests.cpp)
set_tests_properties(product_creative_move_drag_frame_tests PROPERTIES
  LABELS "unit;app;product;creative;move;drag;window;frame;iggy3d")
...
iggy3d_add_unit_test(product_ui_theme_tests
  tests/unit/product_ui_theme_tests.cpp)
...
iggy3d_add_unit_test(product_vulkan_creative_ui_overlay_tests
  tests/unit/product_vulkan_creative_ui_overlay_tests.cpp)
set_tests_properties(product_vulkan_creative_ui_overlay_tests PROPERTIES
  LABELS "unit;app;product;renderer;vulkan;creative;ui;iggy3d")
...
iggy3d_add_unit_test(product_automation_dispatch_tests
  tests/unit/product_automation_dispatch_tests.cpp)
set_tests_properties(product_automation_dispatch_tests PROPERTIES
  LABELS "unit;app;product;automation;dispatch;iggy3d")
...
iggy3d_add_unit_test(product_physics_debug_hud_tests
...
iggy3d_add_unit_test(product_creative_fly_tests
...
iggy3d_apply_warnings(standalone_picking_tests)
add_test(NAME standalone_picking_tests
  COMMAND "$<TARGET_FILE:standalone_picking_tests>")
set_tests_properties(standalone_picking_tests PROPERTIES
  WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
...
add_executable(standalone_placement_tests
  ...
  apps/iggy3d_creative/EditorPlacement.cpp
...
iggy3d_add_unit_test(product_creative_world_launch_tests
  tests/unit/product_creative_world_launch_tests.cpp)
set_tests_properties(product_creative_world_launch_tests PROPERTIES
  LABELS "unit;app;product;creative;world;launch;iggy3d")

iggy3d_add_unit_test(product_creative_no_window_bake_scenario_tests
  tests/unit/product_creative_no_window_bake_scenario_tests.cpp)
set_tests_properties(product_creative_no_window_bake_scenario_tests PROPERTIES
  LABELS "unit;app;product;creative;world;bake;iggy3d")
...
iggy3d_add_unit_test(guard_recon_tests tests/unit/guard_recon_tests.cpp)
set_tests_properties(guard_recon_tests PROPERTIES
  LABELS "unit;runtime;ai;recon;iggy3d")

iggy3d_add_unit_test(recon_intel_tests tests/unit/recon_intel_tests.cpp)
...
iggy3d_add_unit_test(stair_mesh_tests tests/unit/stair_mesh_tests.cpp)
