...
iggy3d_add_unit_test(creative_editor_edits_ownership_tests
  tests/unit/creative_editor_edits_ownership_tests.cpp)
...
add_executable(creative_editor_inspector_ownership_tests
  tests/unit/creative_editor_inspector_ownership_tests.cpp)
target_link_libraries(creative_editor_inspector_ownership_tests PRIVATE
  iggy3d_creative_app)
iggy3d_apply_warnings(creative_editor_inspector_ownership_tests)
add_test(NAME creative_editor_inspector_ownership_tests
  COMMAND "$<TARGET_FILE:creative_editor_inspector_ownership_tests>")
set_tests_properties(creative_editor_inspector_ownership_tests PROPERTIES
  WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
...
add_executable(creative_held_item_operation_ownership_tests
  tests/unit/creative_held_item_operation_ownership_tests.cpp)
target_link_libraries(creative_held_item_operation_ownership_tests PRIVATE
  iggy3d_creative_app)
iggy3d_apply_warnings(creative_held_item_operation_ownership_tests)
add_test(NAME creative_held_item_operation_ownership_tests
  COMMAND "$<TARGET_FILE:creative_held_item_operation_ownership_tests>")
set_tests_properties(creative_held_item_operation_ownership_tests PROPERTIES
  WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
  LABELS "unit;app;creative;input;held_item;architecture;iggy3d")
...
add_executable(creative_editor_world_layout_review_model_tests
  tests/unit/creative_editor_world_layout_review_model_tests.cpp)
target_link_libraries(creative_editor_world_layout_review_model_tests
  PRIVATE iggy3d_creative_app)
iggy3d_apply_warnings(creative_editor_world_layout_review_model_tests)
add_test(NAME creative_editor_world_layout_review_model_tests
  COMMAND "$<TARGET_FILE:creative_editor_world_layout_review_model_tests>")
set_tests_properties(
  creative_editor_world_layout_review_model_tests PROPERTIES
  WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
  LABELS "unit;app;creative;editor;world;layout;review;model;iggy3d")
