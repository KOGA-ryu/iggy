...
1. `ready/E246-controller-split-g13a-target-submit-helper.md`
...
- `docs/refactor_targets.md` is the new current-HEAD effort-ranked refactor
  ...
  dash-submit helper. E245 extracted the G12a move-submit helper. E246 is
  released as a G13a target-submit helper. Keep later controller
