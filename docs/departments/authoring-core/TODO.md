...
| AUT-007 | Retire obsolete Facade compatibility state | Support | Planned | No production callers for `State`, frame packet, packet handler, or `CreativeActiveIdentity` | Delete the dead surface and update focused Facade tests |
