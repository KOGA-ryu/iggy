...
| AUT-008 | Close mutable Facade document escape | Integrated | Planned | Seventeen production calls across five files and 30 test calls across nine files use `documentForPersistence`; the exact replacement map is ready | Execute [AUT-008-LUNA.md](AUT-008-LUNA.md), review as one batch, then delete the escape |
